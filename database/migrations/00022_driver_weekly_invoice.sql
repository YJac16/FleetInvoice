-- =============================================================================
-- WorkOps — Driver weekly invoice (bill-to WCL, one invoice per driver per week)
-- =============================================================================
-- Requires 00011_phase8_billing.sql (rate_cards, generate_period_invoice).
...
-- Company-period invoices remain unique when driver_id is null.
...
-- ---------------------------------------------------------------------------
-- RPC: resolve_invoice_bill_to_company_id
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- RPC: generate_driver_weekly_invoice (SAST week window)
-- ---------------------------------------------------------------------------
...
begin
  ...
  week_start_ts := (p_period_start::timestamp at time zone 'Africa/Johannesburg');
  week_end_ts := (p_period_end::timestamp at time zone 'Africa/Johannesburg');
